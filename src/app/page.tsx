...
function ModernBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[40%] left-[40%] w-[20%] h-[20%] rounded-full bg-pink-500/10 blur-[100px] animate-float"></div>
    </div>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <motion.a
        href="https://wa.me/917055410580?text=Hi%20SavvyIndians!%20I'm%20interested%20in%20your%20AI%20services.%20Can%20you%20help%20me?"
        target="_blank"
        rel="noopener noreferrer"
